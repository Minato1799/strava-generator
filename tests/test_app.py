...
class HttpFlowTests(SimpleTestCase):
    ...
    def test_home_and_health_render(self):
        ...
        self.assertContains(home, "core.css?v=20260820-gpx1")
        self.assertContains(home, "index.css?v=20260820-gpx1")
        self.assertContains(home, "gpx-import.js?v=20260820-gpx1")
        self.assertContains(home, "index.js?v=20260820-gpx1")
